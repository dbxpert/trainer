/**
 * @file    sqlcli.h
 * @brief   The main include for ODBC(or CLI) Core functions
 *
 * @author  eacho, wrpark
 * @version \$Id: sqlcli.h 160174 2018-10-26 04:02:20Z minjoon $
 *
 * (reference : include files of Microsoft Corp.)
 */
...
#include <windows.h>    /* for ODBC preconditions */
#endif  /* _WIN32 */
...
#include "sqlcli_ucode.h"
#include "sqlcli_odbc.h"
#include "sqlcli_epl.h"
...
#define SQL_DESC_EXPRESSION                 1014
...
#define SQL_FLOAT           6 /* float, double*/
#define SQL_REAL            7 /* binary_float */
#define SQL_DOUBLE          8 /* binary_double*/
#if (ODBCVER >= 0x0300)
...
SQLRETURN SQL_API SQLShutdown(SQLHDBC ConnectionHandle, SQLINTEGER mode);
...
SQLRETURN SQL_API cli_comm_set_execute_coll(SQLHSTMT hstmt,
                                            char *sql,
                                            int param_cnt,
                                            short *param_modes,
                                            short *sql_types,
