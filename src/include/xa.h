/**
 * @file    xa.h
 * @brief   XA public header, borrowed from the X/Open CAE Specification.
 *          both ANSI C and Common Usage C.
 * @author  jshwang
 * @version \$Id: xa.h 52898 2011-04-28 02:10:14Z inochangho $
 *
 * XA Client Library 의 기본 구성: "xa.h + xa_api.c"
 */
 ...
 */
/* WARNING: 표준에 _XA_H 대신 XA_H를 사용하도록 되어 있다. */
#ifndef XA_H
#define XA_H
...
struct xa_switch_t {
    ...
    int (XA_API *xa_open_entry)(char *, int, long);
    /* xa_close function pointer */
    int (XA_API *xa_close_entry)(char *, int, long);
    /* xa_start function pointer */
    int (XA_API *xa_start_entry)(XID *, int, long);
    /* xa_end function pointer */
    int (XA_API *xa_end_entry)(XID *, int, long);
    /* xa_rollback function pointer */
    int (XA_API *xa_rollback_entry)(XID *, int, long);
    /* xa_prepare function pointer */
    int (XA_API *xa_prepare_entry)(XID *, int, long);
    /* xa_commit function pointer */
    int (XA_API *xa_commit_entry)(XID *, int, long);
    /* xa_recover function pointer */
    int (XA_API *xa_recover_entry)(XID *, long, int, long);
    /* xa_forget function pointer */
    int (XA_API *xa_forget_entry)(XID *, int, long);
    /* xa_complete function pointer */
    int (XA_API *xa_complete_entry)(int *, int *, int, long);
#else
...
#else
#   ifdef __cplusplus
extern "C" struct xa_switch_t __declspec(dllimport) tbxasw;
#  else
extern struct xa_switch_t __declspec(dllimport) tbxasw;
#  endif
#endif
