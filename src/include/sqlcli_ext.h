/**
 * @file    sqlcli_ext.h
 * @brief   The extended include for ODBC(or CLI) Core functions
 *
 * @author  eacho, wrpark
 * @version \$Id: sqlcli_ext.h 160174 2018-10-26 04:02:20Z minjoon $
 */

#ifndef _SQLCLI_EXT_H
#define _SQLCLI_EXT_H
...
#define SQL_BIND_TYPE_DEFAULT           SQL_BIND_BY_COLUMN  /* Default */
...
#define SQL_CONCUR_DEFAULT              SQL_CONCUR_READ_ONLY /* Default */
...
#define SQL_CURSOR_TYPE_DEFAULT         SQL_CURSOR_FORWARD_ONLY /* Default */
...
#ifdef _OCI_COMMON
#define SQL_C_BDOUBLE   SQL_BDOUBLE     /* BINARY DOUBLE                */
#endif
#if (ODBCVER >= 0x0300)
...
#if (ODBCVER >= 0x0300)
#define SQL_C_SBIGINT   (SQL_BIGINT+SQL_SIGNED_OFFSET)      /* S BIGINT */
#define SQL_C_UBIGINT   (SQL_BIGINT+SQL_UNSIGNED_OFFSET)    /* U BIGINT */
#endif  /* ODBCVER >= 0x0300 */
#define SQL_C_TINYINT   SQL_TINYINT
#define SQL_C_SLONG     (SQL_C_LONG+SQL_SIGNED_OFFSET)      /* S INTEGER */
#define SQL_C_SSHORT    (SQL_C_SHORT+SQL_SIGNED_OFFSET)     /* S SMALLINT */
#define SQL_C_STINYINT  (SQL_TINYINT+SQL_SIGNED_OFFSET)     /* S TINYINT */
#define SQL_C_ULONG     (SQL_C_LONG+SQL_UNSIGNED_OFFSET)    /* U INTEGER */
#define SQL_C_USHORT    (SQL_C_SHORT+SQL_UNSIGNED_OFFSET)   /* U SMALLINT */
#define SQL_C_UTINYINT  (SQL_TINYINT+SQL_UNSIGNED_OFFSET)   /* U TINYINT */
...
#if (ODBCVER >= 0x0300)
/* the following 5 bitmasks are defined in sqlcli.h
