/**
 * @file    sqlcli_ucode.h
 * @brief   The unicode include for ODBC(or CLI) Core functions
 *
 * @author  wrpark
 * @version \$Id: sqlcli_ucode.h 48474 2010-05-17 07:28:14Z wrpark $
 */

#ifndef _SQLCLI_UCODE_H
#define _SQLCLI_UCODE_H
