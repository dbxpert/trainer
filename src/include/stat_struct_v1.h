/**
 * @file    stat_struct_v1.h
 * @brief   instance stat API & library : stat struct type
 *
 * @author  cbpark, chhwang
 * @version $Id: stat_struct_v1.h 142867 2017-04-10 07:22:24Z dongjin_lee $
 */

#ifndef _STAT_STRUCT_V1_H
#define _STAT_STRCUT_V1_H
...
#define _TB_TIMEVAL_T
    ...
    (defined(_LINUX_X86_32) || defined(_LINUX_X86_64) ||                       \
     defined(_LINUX_IA64_64)||                                                 \
     defined(_WIN32) ||                                                        \
     defined(_OS_SOLARIS) ||                                                   \
     defined(_HP_IA64_64) || defined(_HP_PA_RISC_64) ||                        \
     defined(_LINUX_PPC_64) || defined(_LINUX_PPC_32) ||                       \
     defined(_LINUX_S390X_64))
...
struct jc_stat_s {
    ...
    uint64_t used_time;     /* jc_start~jc_end 사이의 총 시간 (usec) */
    uint64_t max_used;      /* jc_start~jc_end 사이의 max time (usec) */
